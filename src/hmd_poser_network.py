...
# Copied from the official HMD-Poser repository:
# https://github.com/Pico-AI-Team/HMD-Poser/blob/main/model/network.py
# The architecture is frozen so that the released checkpoint can be loaded
# with strict=True.  Do not modify the layer names or dimensions.
